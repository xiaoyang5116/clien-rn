...
const AnimatedComponent = (props) => {
    ...
    const onEnd = () => {
        DeviceEventEmitter.emit("TopToTopSmooth", 1)
    }

    const topAnim = useRef(new Animated.Value(220)).current
...
export default TopToTopSmooth = (props) => {
    ...
    useEffect(() => {
        ...
        let count = 0
        const listener = DeviceEventEmitter.addListener('TopToTopSmooth', (num) => {
            count += num

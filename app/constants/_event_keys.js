...
export class EventKeys {
    ...
    static PROPS_NUM_CHANGED = 'PROPS_NUM_CHANGED';
    ...
    static ARTICLE_SHOW_BAG_ANIMATION = 'ARTICLE_SHOW_BAG_ANIMATION';
    static FORCE_UPDATE_STORY_CHAT = 'FORCE_UPDATE_STORY_CHAT';
    static REFRESH_MISSION_PROPSBAR = 'REFRESH_MISSION_PROPSBAR';

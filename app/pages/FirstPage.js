      ...
      <ImageBackground style={{ flex: 1, justifyContent: 'center', flexDirection: 'row', alignItems: 'center' }} source={require('../../assets/bg/first_bg.jpg')}>
        <View style={{ flex: 1, flexDirection: 'column', alignItems: 'center' }}>
          ...
          <ImageButton height={60} source={require('../../assets/button/test_button.png')} selectedSource={require('../../assets/button/test_button_selected.png')} onPress={() => {
            ...
            // 单人对话框
            Modal.show({
              style: 6, title: '神秘阵盘', dialogType: 'FullScreen', textAnimationType: 'TextSingle',
              sections: [
                { key: 'p1', content: ['你迅速跑过去，地面有些东西。', ['盖章过关'], '走开走开，马夫大喝， 正从远处拨开人群走来。', ['边缘闪烁绿'], '获得几颗石头珠子，看起来能卖不少钱。'], btn: [{ title: '去拿菜刀', tokey: "p2", props: [{ propId: 20, num: 10 }], animation: ['盖章过关'] }, { title: '退出', tokey: "next" }, { title: '退出', tokey: "next" }, { title: '退出', tokey: "next" }, { title: '退出', tokey: "next" }, { title: '去拿画轴', tokey: "p3", animation: ['边缘闪烁绿'] }] },

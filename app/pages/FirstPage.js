        ...
        <View style={{ flex: 1, flexDirection: 'column', alignItems: 'center' }}>
          ...
          <ImageButton height={60} source={require('../../assets/button/test_button.png')} selectedSource={require('../../assets/button/test_button_selected.png')} onPress={() => {
            ...
            Modal.show({ 
              ...
              sections: [
<<<<<<< HEAD
                { key: 'p1', content: ['你迅速跑过去，地面有些东西。', ['震屏1','边缘闪烁红'], '走开走开，马夫大喝， 正从远处拨开人群走来。', ['边缘闪烁绿'], '获得几颗石头珠子，看起来能卖不少钱。' ],btn: [{title: '去拿菜刀',tokey: "p2", props: [{ propId: 20, num: 10 }]},{title: '去拿画轴', tokey: "p3"}]},
=======
                { key: 'p1', content: ['你迅速跑过去，地面有些东西。', ['过关1'], '走开走开，马夫大喝， 正从远处拨开人群走来。', ['边缘闪烁绿'], '获得几颗石头珠子，看起来能卖不少钱。'], btn: [{ title: '去拿菜刀', tokey: "p2", props: [{ propId: 20, num: 10 }], animation: ['过关1'] }, { title: '去拿画轴', tokey: "p3", animation: ['边缘闪烁绿'] }] },
>>>>>>> 463696fc504fac614df5139aaca01aa7e52c8b75
